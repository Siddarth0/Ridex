...
export default function RegisterPage() {
  ...
  const requiresVerify = res?.data?.data?.requiresEmailVerification
  toast.success(requiresVerify ? "🎉 Registration successful! Verify your email." : "🎉 Registration successful!")
        resetForm()
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="flex min-h-screen">
        ...
        <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-emerald-600 via-teal-600 to-cyan-700 relative overflow-hidden">
          ...
          <div className="relative z-10 flex flex-col justify-start px-12 py-16 text-white">
            {/* Logo */}
            {/*<div className="mb-8">
